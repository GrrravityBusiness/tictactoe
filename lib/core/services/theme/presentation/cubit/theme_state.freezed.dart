...
mixin _$ThemeState {
 ...
 ThemeMode get mode; AppTheme get themeData;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeState&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.themeData, themeData) || other.themeData == themeData));
}


@override
int get hashCode => Object.hash(runtimeType,mode,themeData);

@override
String toString() {
  return 'ThemeState(mode: $mode, themeData: $themeData)';
}
...
@useResult
$Res call({
 ThemeMode mode, AppTheme themeData
});
...
/// Create a copy of ThemeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mode = null,Object? themeData = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode mode,  AppTheme themeData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.mode,_that.themeData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode mode,  AppTheme themeData)  $default,) {final _that = this;
switch (_that) {
case _ThemeState():
return $default(_that.mode,_that.themeData);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode mode,  AppTheme themeData)?  $default,) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.mode,_that.themeData);case _:
  return null;
...
class _ThemeState extends ThemeState {
  const _ThemeState({required this.mode, required this.themeData}): super._();
  

@override final  ThemeMode mode;
@override final  AppTheme themeData;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeState&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.themeData, themeData) || other.themeData == themeData));
}
...
/// Create a copy of ThemeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mode = null,Object? themeData = null,}) {
